...
export default function WatchlistPanel({ assets = MOCK_PRICES.slice(0, 5) }: Props) {
  console.debug('[WatchlistPanel] showing', assets.length, 'items')
