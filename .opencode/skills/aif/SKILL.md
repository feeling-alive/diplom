...
```bash
$PYTHON ~/.opencode/skills/aif-skill-generator/scripts/security-scan.py <installed-skill-path>
```
...
7. For each external skill from skills.sh:
   ...
   $PYTHON ~/.opencode/skills/aif-skill-generator/scripts/security-scan.py <installed-path>
   ```
