...
from app.routes import chat, crypto, dashboard, forex, news, profile, quotes, search, subscription
...
logger.info("[main] auth/users/subscription/dashboard/news/chat/search routes mounted")
